        ...
        <div className="min-h-screen flex items-center justify-center bg-neutral-50">
          <div className="text-center p-8 max-w-md">
            ...
            <div className="flex flex-col gap-1 text-center">
              ...
              <p className="text-neutral-600 text-base w w-8/12 mx-auto">Img V2 Pro encountered an unexpected error while processing your request.</p>
              {isDev && this.state?.error && (
                <div className="mt-4 p-3 text-left text-xs bg-white border rounded-md text-neutral-700 overflow-auto max-h-48">
                  <div className="font-semibold mb-1">Details (dev only):</div>
                  <div className="break-all"><strong>{String(this.state.error?.name || 'Error')}:</strong> {String(this.state.error?.message || '')}</div>
                </div>
              )}
            </div>
            <div className="flex justify-center items-center mt-6">
              ...
              <button
                ...
                className="ml-3 bg-neutral-200 hover:bg-neutral-300 text-neutral-800 font-medium py-2 px-4 rounded transition-colors duration-200 shadow-sm"
              >
                Reload
              </button>
            </div>
